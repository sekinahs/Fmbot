    ...
    if chat_type == enums.ChatType.PRIVATE:
        try:
            ...
            await message.reply_text(
                ...
                "<b>Gᴇᴛ Yᴏᴜʀ Gʀᴏᴜᴘ Iᴅ Bʏ Aᴅᴅɪɴɢ Tʜɪs Bᴏᴛ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ Aɴᴅ Usᴇ <code>/id</code></b>",
                quote=True
            )
            return
            ...
            if addcon:
                await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                                           [[
                                             InlineKeyboardButton('Gᴏ Tᴏ Pᴍ', url=f"https://t.me/{temp.U_NAME}")
                                           ]]
                    ),
                ...
                await message.reply_text(
                    "**Yᴏᴜ'Rᴇ Aʟʀᴇᴀᴅʏ Cᴏɴɴᴇᴄᴛᴇᴅ Tᴏ Tʜɪs Cʜᴀᴛ !**",
                    quote=True
                )
        else:
            await message.reply_text("Aᴅᴅ Mᴇ As Aᴅᴍɪɴ Iɴ Gʀᴏᴜᴘ.", quote=True)
    except Exception as e:
        logger.exception(e)
