...
async def addfilter(client, message):
    ...
    if not userid:
        return await message.reply(f"Yᴏᴜ Aʀᴇ Aɴᴏɴʏᴍᴏᴜs Aᴅᴍɪɴ. Use /connect {message.chat.id} Iɴ PM")
    ...
    if chat_type == enums.ChatType.PRIVATE:
        ...
        if grpid is not None:
            ...
            try:
                ...
                await message.reply_text("Mᴀᴋᴇ Sᴜʀᴇ I'M Pʀᴇsᴇɴᴛ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ!!", quote=True)
                return
        else:
            await message.reply_text("I'M Nᴏᴛ Cᴏɴɴᴇᴄᴛᴇᴅ Tᴏ Aɴʏ Gʀᴏᴜᴘ!", quote=True)
            return
...
async def deletefilter(client, message):
    ...
    try:
        ...
        await message.reply_text(
            "<b>Mᴇɴᴛɪᴏɴ Tʜᴇ Fɪʟᴛᴇʀɴᴀᴍᴇ Wʜɪᴄʜ Yᴏᴜ Wᴀɴɴᴀ Dᴇʟᴇᴛᴇ!</b>\n\n"
            "<code>/del filtername</code>\n\n"
            "Usᴇ /viewfilters Tᴏ Vɪᴇᴡ Aʟʟ Aᴠᴀɪʟᴀʙʟᴇ Fɪʟᴛᴇʀs",
            quote=True
        )
        return
