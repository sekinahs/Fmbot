...
async def get_all_gfilters(client, message):
    ...
    if count:
        gfilterlist = f"Tᴏᴛᴀʟ Nᴜᴍʙᴇʀ Oғ Gғɪʟᴛᴇʀs : {count}\n\n"
        ...
        gfilterlist = f"Tʜᴇʀᴇ Aʀᴇ Nᴏ Aᴄᴛɪᴠᴇ Gғɪʟᴛᴇʀs."
...
async def deletegfilter(client, message):
    try:
        ...
        await message.reply_text(
            "<b>Mᴇɴᴛɪᴏɴ Tʜᴇ Gғɪʟᴛᴇʀɴᴀᴍᴇ Wʜɪᴄʜ Yᴏᴜ Wᴀɴɴᴀ Dᴇʟᴇᴛᴇ!</b>\n\n"
            "<code>/delg gfiltername</code>\n\n"
            "Usᴇ /viewgfilters Tᴏ Vɪᴇᴡ Aʟʟ Aᴠᴀɪʟᴀʙʟᴇ Gғɪʟᴛᴇʀs",
            quote=True
        )
        return
