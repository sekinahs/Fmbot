...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('Uᴘᴅᴀᴛᴇs', url='https://t.me/Binge_Pirates'),
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ', url='https://t.me/Binge_Request_Group')
                  ]]
...
async def delete(bot, message , to_dlt):
    ...
    for file_type in ("document", "video", "audio"):
        ...
        await msg.edit('<b>Tʜɪs Is Nᴏᴛ Sᴜᴘᴘᴏʀᴛᴇᴅ Fɪʟᴇ Fᴏʀᴍᴀᴛ</b>')
        return
...
async def delete_all_index(bot, message):
    await message.reply_text(
        '<b>Tʜɪs Wɪʟʟ Dᴇʟᴇᴛᴇ Aʟʟ Iɴᴅᴇxᴇᴅ Fɪʟᴇs.\nDᴏ Yᴏᴜ Wᴀɴᴛ Tᴏ Cᴏɴᴛɪɴᴜᴇ??</b>',
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.message.edit('<b>Sᴜᴄᴄᴇssғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ Aʟʟ Tʜᴇ Iɴᴅᴇxᴇᴅ Fɪʟᴇs.</b>')
...
async def deletemultiplefiles(bot, message):
    btn = [[
            InlineKeyboardButton("Pʀᴇᴅᴠᴅ", callback_data="predvd"),
            InlineKeyboardButton("Pʀᴇᴅᴠᴅ Rɪᴘ", callback_data="predvdrip")
          ],[
            InlineKeyboardButton("Hᴅᴛs", callback_data="hdts"),
            InlineKeyboardButton("Hᴅ-Ts", callback_data="hdtss")
          ],[
            InlineKeyboardButton("Hᴅᴄᴀᴍ", callback_data="hdcam"),
            InlineKeyboardButton("Hᴅ-Cᴀᴍ", callback_data="hdcams")
          ],[
            InlineKeyboardButton("Cᴀᴍʀɪᴘ", callback_data="camrip"),
